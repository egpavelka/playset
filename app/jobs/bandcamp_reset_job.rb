...
from flagging the crawler IP (see https://stackoverflow.com/questions/17489621/change-ip-address-in-ruby),
...
clearing audio src URLs from the DOM when developer tools are opened (via browser
shortcuts or context menus, but wiping all audio and forcing a refresh everytime
the user right clicks is totally insane.
